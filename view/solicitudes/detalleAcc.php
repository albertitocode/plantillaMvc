...
<div class="page-header">
    <h3 class="fw-bold mb-3">Accidentes</h3>
    <ul class="breadcrumbs mb-3">
        <li class="nav-home">
            <a href="<?php echo getUrl("Solicitud", "Solicitud", "getAccidentes"); ?>">
                <i class="icon-home"></i>
            </a>
        </li>
        <li class="separator">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($accidentes as $acc) {
                        ...
                        echo "       <p>" . $acc['solicitud_accidente_id'] . "</p>";
                        echo "   </div>";
                        echo "  <div class='form-group'>";
                        echo "      <label for=''>Fecha</label>";
                        echo "       <p>" . $acc['solicitud_accidente_fecha_creacion'] . "</p>";
                        echo "  </div>";
                        echo "  <div class='form-group'>";
                        echo "      <label for='' class='fw-bold'>Tipo de choque</label>";
                        echo "       <p>" . $nombre_tipo_choque . "</p>";
                        echo "  </div>";
                        echo "  <div class='form-group'>";
                        ...
                        echo "       <p>" . $acc['solicitud_accidente_direccion'] . "</p>";
                        echo "    </div>";
                        echo "    <div class='form-group'>";
                        ...
                        echo "    </div>";
                        echo "    <div class='form-group'>";
                        echo "       <label for=''> choque detalle </label>";
                        echo "       <p>" . $acc['detalle_choque_nombre'] . "</p>";
                        echo "    </div>";
                        echo "</div>";
                        echo "<div class='col-md-6 col-lg-4'>";
                        echo "    <div class='form-group'>";
                        echo "       <label for=''>Descripcion</label>";
                        echo "       <p>" . $acc['solicitud_accidente_descripcion'] . "</p>";
                        echo "    </div>";
                        echo "    <div class='form-group'>";
                        echo "       <label for=''>Lesionados</label>";
                        echo "       <p>" . $acc['solicitud_accidente_lesionados'] . "</p>";
                        echo "    </div>";
                        echo "    <div class='form-group'>";
                        echo "       <label for='image' class='d-block'>Imagen de la señal dañada</label>";
                        echo "       <img src=" . $acc['solicitud_accidente_imagen'] . " class='img-fluid' data-toggle='modal' data-target='#imageModal' ";
