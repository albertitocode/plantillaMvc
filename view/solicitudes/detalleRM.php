...
<div class="page-header">
    <h3 class="fw-bold mb-3">Reductores</h3>
    <ul class="breadcrumbs mb-3">
        <li class="nav-home">
            <a href="<?php echo getUrl("Solicitud", "Solicitud", "getReductorMalEstado"); ?>">
                <i class="icon-home"></i>
            </a>
        </li>
        <li class="separator">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    foreach ($solicitud as $soli) {
                        ...
                        echo "       <p>" . $soli['solicitud_reductores_mal_estado_id'] . "</p>";
                        echo "   </div>";
                        echo "  <div class='form-group'>";
                        echo "      <label for=''>Fecha</label>";
                        echo "       <p>" . $soli['solicitud_senial_mal_estado_fecha_creacion'] . "</p>";
                        echo "  </div>";
                        echo "  <div class='form-group'>";
                        ...
                        echo "       <p>" . $soli['solicitud_reductores_mal_estado_direccion'] . "</p>";
                        echo "    </div>";
                        echo "    <div class='form-group'>";
                        ...
                        echo "       <p>" . $soli['solicitud_reductores_mal_estado_descripcion'] . "</p>";
                        echo "    </div>";
                        echo "    <div class='form-group'>";
                        ...
                        echo "       <img src=" . $soli['solicitud_reductores_mal_estado_imagen'] . " class='img-fluid' data-toggle='modal' data-target='#imageModal' ";
