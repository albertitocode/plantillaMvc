...
<body>
    ...
    <div class="mt-5">
        ...
        ?>
    <form action="<?php echo getUrl2("Usuarios","Usuarios","postCreate","","ajax");?>" method="post" id="formUsu" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="usuario_contrasenia" id="usuario_contrasenia"
                                            class="form-control" placeholder="Clave" autocomplete="new-password">
                                ...
                                <div class="col-md-6 col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="usuario_num_identificacion"
