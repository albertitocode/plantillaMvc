            ...
            <input type="text" name="usu_id" class="form-control" placeholder="Id">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="usuario_id" id="" class="form-control" placeholder="<?= $_SESSION['usuario_id']?>">
                                </div>

                            
                                <div class="form-group">
                                    <label for="usuario_nombre_1">Primer nombre</label>
                                    <input type="text" name="usuario_nombre_1" id="" class="form-control" placeholder="<?= $_SESSION['nombre'] ?>">
